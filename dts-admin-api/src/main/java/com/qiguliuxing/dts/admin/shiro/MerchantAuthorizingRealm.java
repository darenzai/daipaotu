 ...
 * @since 1.0.0
 */
public class MerchantAuthorizingRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        //查询数据库账号密码
        List<DtsMerchant> adminList = dtsMerchantService.findMerchant(username);
        //进行断言 是否存在两个用户名  安全策略
        ...
        //拿到第一个查出来的用户
        DtsMerchant admin = adminList.get(0);
