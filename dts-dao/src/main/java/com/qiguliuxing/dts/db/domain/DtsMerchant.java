...
public class DtsMerchant {
    ...
    @TableId(value = "id_brand", type = IdType.ID_WORKER_STR)
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getDes() == null ? other.getDesc() == null : this.getDes().equals(other.getDesc()))
                && (this.getTele() == null ? other.getTel() == null : this.getTele().equals(other.getTel()));
    }
